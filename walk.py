...
class GoofyWalk(MovingCameraScene):
    ...
    def construct(self):
        ...
        dot = Dot(color=GREEN, radius=0.10)
        ...
        for i in range(1, 800):
            ...
            if y_new < frame_height/2 - 1 and y_new > -frame_height/2 + 1 and x_new < frame_width/2 - 1 and x_new > -frame_width/2 + 1:
                if i[0] == 0:
                    self.play(dot.animate.shift(0.25*i[1]*UP), run_time=0.01)
                else:
                    self.play(dot.animate.shift(0.25*i[0]*RIGHT), run_time=0.01)
            else:
                continue

        self.wait(2)

class BrainletWalk(MovingCameraScene):
...
class RandomWalk2(Scene):
    ...
    def construct(self):
        ...
        for i in range(1, 900):
            ...
            # j = i This is probably me being retarded
